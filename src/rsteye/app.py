...
class RstEyeApp:
    def __init__(
        self,
        image_path,
        interval_seconds=DEFAULT_POPUP_INTERVAL_MINUTES * 60,
        popup_duration_seconds=DEFAULT_POPUP_DURATION_SECONDS,
        fullscreen=False,
    ):
    ...
    def _schedule_next_prompt(self):
        self._popup_active = False
        ...
        try:
            ...
            def load_image():
                ...
                def update_frame(frame_index):
                    ...
                    window.after(
                        50, update_frame, (frame_index + 1) % len(self._frame_images)
                    )
...
def main():
    app = RstEyeApp(
        "resources/med.gif",
        interval_seconds=read_int_env("POPUP_INTERVAL", DEFAULT_POPUP_INTERVAL_MINUTES)
        * 60,
